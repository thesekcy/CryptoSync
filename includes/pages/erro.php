  ...
  <head>
    ...
    <link rel="stylesheet" href="node_modules/bootstrap/compiler/erro_style.css">
  ...
  <body>
    ...
    <div class="container"> 
      <div class="erro text-center">
        <img src="img/erro.png" class="img-erro">
        ...
        <div class="container col-2"> 
          <a class="nav-link btn btn-outline-primary btnInicial text-center" href="index.html">Pagina Inicial</a>
        </div>
      </div>
    </div>
