  ...
  <div class="container">
    ...
    <div class="row sobre-cols">
      ...
      <div class="col-md-4 wow fadeInUp">
        <div class="sobre-col">
          <div class="img">
            <img src="<?=HOME_URL?>/_img/sobre-missao.jpg" alt="" class="img-fluid">
      ...
      <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
        <div class="sobre-col">
          <div class="img">
            <img src="<?=HOME_URL?>/_img/sobre-plano.jpg" alt="" class="img-fluid">
      ...
      <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
        <div class="sobre-col">
          <div class="img">
            <img src="<?=HOME_URL?>/_img/sobre-visao.jpg" alt="" class="img-fluid">
...
<section class="section fatos">
  <div class="container">
    ...
    <div class="fatos-img">
      <img src="<?=HOME_URL?>/_img/fatos-img.png" alt="" class="img-fluid" width="900px">
    </div>
  </div>
</section><!-- .fatos -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-lg-3">
        <div class="feature-block">
          <img src="<?=HOME_URL?>/_img/svg/cloud.svg" alt="img" class="img-fluid">
        ...
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <div class="price-icon d-flex justify-content-center">
              <img src="<?=HOME_URL?>/_img/svg/premium.svg" alt="Stack" class="img-fluid img-responsive" width="50px">
            </div>
            <hr>
            <ul class="fa-ul">
      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <div class="price-icon d-flex justify-content-center">
              <img src="<?=HOME_URL?>/_img/svg/premiumplus.svg" alt="Stack" class="img-fluid img-responsive" width="50px">
            </div>
            <hr>
            <ul class="fa-ul">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-body">
            ...
            <div class="price-icon d-flex justify-content-center">
              <img src="<?=HOME_URL?>/_img/svg/max2.svg" alt="Stack" class="img-fluid img-responsive" width="50px">
            </div>
            <hr>
            <ul class="fa-ul">
