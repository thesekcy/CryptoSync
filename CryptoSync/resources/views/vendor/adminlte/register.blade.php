...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		...
		<script rel="text/javascript" src="{{ asset('vendor/site/Style/dist/js/jquery.inputmask.bundle.js')}}"></script>
		<script rel="text/javascript" src="{{ asset('vendor/site/Style/dist/js/viacep.js')}}"></script>
		<script rel="text/javascript" src="{{ asset('vendor/site/Style/dist/js/cadastro.js')}}"></script>
		<script rel="text/javascript" src="{{ asset('vendor/site/Style/dist/js/toast.min.js')}}"></script>
