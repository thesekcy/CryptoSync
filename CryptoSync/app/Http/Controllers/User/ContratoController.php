...
class ContratoController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		if (auth()->check()) {
			$perfils = $this->perfil->where('id_users',auth()->user()->id )->first();
	...
	public function list()
	{
		...
		->where('id_contratante',auth()->user()->id) 
		->get();
	...
	public function contrato($id)
	{
		...
		return view('user.contrato.contrato',compact('contrato'));
	}
	public function print($id)
	{
		...
		return view('user.contrato.contratoPrint',compact('contrato'));
	}
